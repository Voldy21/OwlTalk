async function navbar(bool){
    ...
    <div class="container">
    <!-- Login Button -->
    ${ !bool ? "<a class='button-style btn btn-info btn-sm px-1 mr-2' href='login.html' role='button'>Login</a>" : "<button id='logout' class='button-style btn btn-info btn-sm px-1 mr-2' role='button'>Logout</button>"}
    <!-- User Icon -->
